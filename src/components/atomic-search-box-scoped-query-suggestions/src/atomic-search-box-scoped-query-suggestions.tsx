...
import { dispatchSearchBoxSuggestionsEvent, SearchBoxSuggestionElement, SearchBoxSuggestions, SearchBoxSuggestionsBindings } from '@coveo/atomic';
...
export class AtomicSearchBoxScopedQuerySuggestions {
  ...
  private renderItem(suggestion: Suggestion) {
    ...
    return {
      ...
      key: `qs-${encodeURI(suggestion.rawValue)}`,
